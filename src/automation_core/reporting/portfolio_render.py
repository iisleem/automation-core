...
function renderCompare(){
  ...
  if(runs.length>=2){
    ...
    document.getElementById('cmp-delta').innerHTML='<div style="background:var(--surface);border:1px solid var(--border);border-radius:16px;box-shadow:var(--shadow);padding:20px;overflow-x:auto;"><h2 style="font-family:\'Manrope\',sans-serif;font-size:16px;font-weight:700;margin:0 0 14px;">Delta vs Baseline · '+esc(base.run_id)+'</h2>'
      +'<table style="width:100%;border-collapse:collapse;font-size:13px;"><thead><tr style="background:var(--surfaceAlt);"><th style="text-align:left;padding:10px 12px;font-size:11px;letter-spacing:0.05em;color:var(--faint);text-transform:uppercase;white-space:nowrap;">Run</th><th style="text-align:right;padding:10px 12px;font-size:11px;letter-spacing:0.05em;color:var(--faint);text-transform:uppercase;white-space:nowrap;">Pass Rate</th><th style="text-align:right;padding:10px 12px;font-size:11px;letter-spacing:0.05em;color:var(--faint);text-transform:uppercase;white-space:nowrap;">Failed</th><th style="text-align:right;padding:10px 12px;font-size:11px;letter-spacing:0.05em;color:var(--faint);text-transform:uppercase;white-space:nowrap;">Flaky</th><th style="text-align:right;padding:10px 12px;font-size:11px;letter-spacing:0.05em;color:var(--faint);text-transform:uppercase;white-space:nowrap;">Duration</th></tr></thead><tbody>'+rows+'</tbody></table></div>';
